...
schema.collections = [
    {
        ...
        schema: {
          ...
          meta: {
            display_template: "{{of_share_size.csa_share_size_name}} {{of_share_size.of_type.csa_share_type_name}}"
          },
    }
];
...
schema.fields = [
...

    {
        ...
        meta: {
            ...
            options: {
                enableCreate: false,
                display_template: "{{csa_share_size_name}} {{of_type.csa_share_type_name}}",
            },
            special: ["m2o"],
        },
        type: "integer",
    },
    {
        ...
        meta: {
            ...
            options: {
                enableCreate: false,
                display_template: "{{csa_membership_of.first_name}}{{csa_membership_of.last_name}}",
            },
            special: ["m2o"],
        },
    },
